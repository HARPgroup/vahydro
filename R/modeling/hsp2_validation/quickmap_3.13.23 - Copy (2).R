...
watersheds_b <-sqldf(paste('SELECT *,
                          CASE
                            WHEN "Qout" < ',as.numeric(quantile(watersheds_b$Qout,0.05)),' THEN "',map_cols[1],'"
                            WHEN "Qout" BETWEEN ',as.numeric(quantile(watersheds_b$Qout,0.05)),' AND ',as.numeric(quantile(watersheds_b$Qout,0.25)),' THEN "',map_cols[2],'"
                            WHEN "Qout" BETWEEN ',as.numeric(quantile(watersheds_b$Qout,0.25)),' AND ',as.numeric(quantile(watersheds_b$Qout,0.50)),' THEN "',map_cols[3],'"
                            WHEN "Qout" BETWEEN ',as.numeric(quantile(watersheds_b$Qout,0.50)),' AND ',as.numeric(quantile(watersheds_b$Qout,0.75)),' THEN "',map_cols[4],'"
                            WHEN "Qout" BETWEEN ',as.numeric(quantile(watersheds_b$Qout,0.75)),' AND ',as.numeric(quantile(watersheds_b$Qout,0.95)),' THEN "',map_cols[5],'"
                            WHEN "Qout" > ',as.numeric(quantile(watersheds_b$Qout,0.95)),' THEN "',map_cols[6],'"
                            ELSE "#FFFFFF"
                          END AS color
...
legend("topright", legend=c(paste0("0%-5%: ",round(as.numeric(quantile(watersheds_b$Qout,0.0)),0),"-",round(as.numeric(quantile(watersheds_b$Qout,0.05)),0)),
                            paste0("5%-25%: ",round(as.numeric(quantile(watersheds_b$Qout,0.05)),0),"-",round(as.numeric(quantile(watersheds_b$Qout,0.25)),0)),
                            paste0("25%-50%: ",round(as.numeric(quantile(watersheds_b$Qout,0.25)),0),"-",round(as.numeric(quantile(watersheds_b$Qout,0.50)),0)),
                            paste0("50%-75%: ",round(as.numeric(quantile(watersheds_b$Qout,0.50)),0),"-",round(as.numeric(quantile(watersheds_b$Qout,0.75)),0)),
                            paste0("75%-95%: ",round(as.numeric(quantile(watersheds_b$Qout,0.75)),0),"-",round(as.numeric(quantile(watersheds_b$Qout,0.95)),0)),
                            paste0("95%-100%: ",round(as.numeric(quantile(watersheds_b$Qout,0.95)),0),"-",round(as.numeric(quantile(watersheds_b$Qout,1)),0))
                            ),
