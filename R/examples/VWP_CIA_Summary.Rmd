...
```{r makeCUplots, echo=FALSE, include=FALSE, results = "asis"}
cu_plots = list()
...
#for (i in 1:length(runid.list)){
  cat(paste("#### Cumulative use chart for", run_names[runid.list[1]],"\n"))
  cat(cu_plots[[1]]$caption_text)
  cat("\n")
  cu_plots[[1]]
  cat("\n\n\\pagebreak\n")
  #break
#}
  ...
  cat(paste("#### Cumulative use chart for", run_names[runid.list[2]],"\n"))
  cat(cu_plots[[2]]$caption_text)
  cat("\n")
  cu_plots[[2]]
  cat("\n\n\\pagebreak\n")
  #break
