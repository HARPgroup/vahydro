...
```{r LocationMap, echo=FALSE, results = "asis"}
  fig_path <- paste0(site.plots,"/data/proj3/out/fig.location_map.",fac.model$pid,".png")
  cat(paste0("![](",fig_path,")"),"\n")
``` 
...
for(u in 1:length(figs.list)){
  fig_path <- figs.list[u]
  fig_path_30daymax <- figs.list.30daymax[u]
  cat("\n\n## Unmet Demand: run ",rlist[u],"\n\n")
    cat(paste0("![](",fig_path,")"),"\n")
  cat("\n\n## 30 Day Max Unmet Demand: run ",rlist[u],"\n\n")  
    cat(paste0("![](",fig_path_30daymax,")"),"\n")
  cat("\n\n\\pagebreak\n")
}
``` 
