...
rseg.hydroid <- 476998 # Ex: Crooked Run = 476998, South Fork Powell River below BSG = 477140, SF Powell at dam: 462757
...
cat("__River Model Description\n")
cat(paste(rseg_model_info$model_overview$value,"\n"))
cat("__Facility & Intake Model Description\n")
cat(paste(fac_model_info$model_overview$value,"\n"))
```
...
```{r LoadSiteInfo, echo=FALSE, results = "asis"}
