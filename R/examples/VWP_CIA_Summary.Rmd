...
```{r IFIMPlot, include=FALSE, echo=FALSE}
# get habitat object from riverseg
# if it exists, and plots exist, go for it.
# if it exists and plots don't exist, messaage user.
``` 
