...
source(paste(github_location,"/hydro-tools/R/om_demand_table.R",sep="")) #Used during development
...
if (!is.null(demand_url)) {
    cat("\n\n## Facility Base Demand Before Conservation: ", run_info$reports$scenario_name$value,"\n\n")
    cat(paste0("![](",demand_url,")"),"\n")
    cat("\n\n\\pagebreak\n")
} else {
  #cat("NULL demand_url\n")
