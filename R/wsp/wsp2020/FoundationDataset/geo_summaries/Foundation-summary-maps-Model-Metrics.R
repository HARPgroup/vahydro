...
######################################################################################################
######################################################################################################
# JOIN METRIC DATA BY RIVER SEGMENT TO RIVER SEGMENT GEOMETRY LAYER
...
# CHANGE COLUMN TO NUMERIC FOR PLOTTING
metric_data$attribute_value=as.numeric(levels(metric_data$attribute_value))[metric_data$attribute_value]
metric_data$attribute_value=as.numeric(metric_data$attribute_value)
metric_data[,4]
######################################################################################################
######################################################################################################
