...
metric <- "l30_Qout"
plot_title <- "30 Day Low Flow (Percent Change 2020 to p10 Climate Change)"
...
scale_fill_manual(values=c("darkolivegreen3","plum3","coral3"),
                  name = "Legend",
                  labels = c(">= 0%",
                             "-20% to -10%",
                             "More than -20%"))+
...
ggsave(plot = map, file = paste0(folder, "state_plan_figures/single_basin/chg_11_to_15_",metric,"_",minorbasin,"_map.png"), width=6.5, height=5)
