...
metric <- "l30_Qout"
plot_title <- "30 Day Low Flow (Percent Change 2020 to p90 Climate Change)"
...
ggsave(plot = map, file = paste0(folder, "state_plan_figures/single_basin/chg_11_to_16_",metric,"_",minorbasin,"_map.png"), width=6.5, height=5)
