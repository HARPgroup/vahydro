...
minorbasin.mapgen <- function(minorbasin,metric,runid_a,runid_b,wd_points = "OFF",rsegs = "ON"){
  ...
  #DIVISIONS IN MGD
  div <- c(0.5,1.0,2.0,5.0,10,25,50)
  
  bins_sql <-  paste("SELECT *,
	                  CASE WHEN mp_2040_mgy/365.25 < ",div[1]," THEN '1'
		                WHEN mp_2040_mgy/365.25 >=  ",div[1]," AND mp_2040_mgy/365.25 < ",div[2]," THEN '2'
		                WHEN mp_2040_mgy/365.25 >=  ",div[2]," AND mp_2040_mgy/365.25 < ",div[3]," THEN '3'
		                WHEN mp_2040_mgy/365.25 >=  ",div[3]," AND mp_2040_mgy/365.25 < ",div[4]," THEN '4'
		                WHEN mp_2040_mgy/365.25 >=  ",div[4]," AND mp_2040_mgy/365.25 < ",div[5]," THEN '5'
		                WHEN mp_2040_mgy/365.25 >= ",div[5]," AND mp_2040_mgy/365.25 < ",div[6]," THEN '6'
		                WHEN mp_2040_mgy/365.25 >= ",div[6]," AND mp_2040_mgy/365.25 < ",div[7]," THEN '7'
		                ELSE '8'
		                END AS bin
		                FROM mp_layer",sep="")
  ...
  if (wd_points == "OFF") {
    ...
    if (rsegs == "ON") {
      ...
      map <- ggdraw(source_current +
                    ...
                    #---------------------------------------------------------------
                    geom_point(data = intake_bin_1, aes(x = Longitude, y = Latitude), colour="black", fill ="purple4", pch = 22, size = 1) +
                    geom_point(data = intake_bin_2, aes(x = Longitude, y = Latitude), colour="black", fill ="purple4", pch = 22, size = 2) +
                    geom_point(data = intake_bin_3, aes(x = Longitude, y = Latitude), colour="black", fill ="purple4", pch = 22, size = 3) +
                    geom_point(data = intake_bin_4, aes(x = Longitude, y = Latitude), colour="black", fill ="purple4", pch = 22, size = 4) +
                    geom_point(data = intake_bin_5, aes(x = Longitude, y = Latitude), colour="black", fill ="purple4", pch = 22, size = 5) +
                    geom_point(data = intake_bin_6, aes(x = Longitude, y = Latitude), colour="black", fill ="purple4", pch = 22, size = 6) +
                    geom_point(data = intake_bin_7, aes(x = Longitude, y = Latitude), colour="black", fill ="purple4", pch = 22, size = 7) +
                    geom_point(data = intake_bin_8, aes(x = Longitude, y = Latitude), colour="black", fill ="purple4", pch = 22, size = 8) +
