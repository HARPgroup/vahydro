...
#   
 ...
 #  div1 <- -20
  ...
  # 
  # if (nrow(bin1) > 0) {
  #   geom1 <- geom_sf(data = bin1,aes(geometry = geom,fill = 'antiquewhite',colour='grey35'), inherit.aes = FALSE)
  #   color_values <- "#ad6c51"
  ...
  #print(class(map_divs$layers))
  #print(map_divs$layers[1])
