...
metric <- "l30_Qout"
plot_title <- "30 Day Low Flow (Percent Change 2020 to p50 Climate Change)"
#plot_title <- "7Q10 (Percent Change 2020 to 2040)"
...
RSeg_data <- paste("SELECT *,
                  ...
                  round(((b.runid_14 - b.runid_11) / b.runid_11) * 100,2) AS chg_11_to_14,
...
ggsave(plot = map, file = paste0(folder, "state_plan_figures/single_basin/chg_11_to_14_",metric,"_",minorbasin,"_map.png"), width=6.5, height=5)
#ggsave(plot = map, file = paste0(folder, "state_plan_figures/single_basin/chg_11_to_13_",metric,"_",minorbasin,"_map.pdf"), width=6.5, height=5)
