...
lrelid = 352171 # camp creek lake element
# facility
fpid = 4827020
fhid = 73024
felid = 279233
...
datlr4 <- om_get_rundata(lrelid, 400, site = omsite)
plot(datlr4$impoundment_lake_elev ~ datlr4$impoundment_use_remain_mg)
datlr601 <- om_get_rundata(lrelid, 600, site = omsite)
