...
for(i in 1:nrow(outlets)) {
  fn_check_cumulative(outlets[i,], wshed_case, "wd_400", "wdcum_400")
  #  fn_check_cumulative(outlets[i,], wshed_case, "wd_600", "wdcum_600")
}

fn_check_cumulative(
  wshed_case[which(wshed_case$riverseg == 'JL7_7100_7030'),],
  wshed_case, wd_col, wdc_col)
fn_cbp_upstream('JL7_7100_7030', all_segments)
