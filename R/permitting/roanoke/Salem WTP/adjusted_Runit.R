...
elid = 251597  #North and South Fork (Confluence) Roanoke River
gage_number = '02053800' # RAPPAHANNOCK RIVER NEAR FREDERICKSBURG, VA
...
hdat <- as.data.frame(hdat)
dat3 <- as.data.frame(gage_data)
dat3 <- sqldf(
  "
    select a.year, a.month, a.day, 
       a.flow as usgs, b.Qout as vahydro
    from dat3 as a 
    left outer join hdat as b
