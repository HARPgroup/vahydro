...
minorbasin_map <- basemap.obj + 
  ...
  transfer_geom + transfer_point_label +
  ...
  scale_colour_manual(name = c("Legend"),
                      values = c("gray30","black","orange","gray30"),
                      labels = c("River Segments","Intake","Wells","Transfer"),
                      guide = guide_legend(override.aes = list(linetype = c("solid", "blank", "blank","dotted"), 
                                                               alpha = c(1,1,1,1),
                                                               shape = c(NA,16,16,NA)))) +
