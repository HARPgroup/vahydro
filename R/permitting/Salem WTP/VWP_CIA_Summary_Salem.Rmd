...
# Set column widths
#users <- width(users, j = 2:length(usersdf[1,]), width = 1.9)
#users <- width(users, j = 1, width = 2.5)
...
#users <- bg(users, i = ~ Description == "River Segment Model Statistics:", bg = "#EFEFEF", part = "body")
#users <- bg(users, i = ~ Description == "Facility Model Statistics:", bg = "#EFEFEF", part = "body")
#fontsize(users, size = 9)
