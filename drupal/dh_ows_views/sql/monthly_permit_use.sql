CREATE or REPLACE VIEW view_dh_ows_monthly_permit_use as (
  (
    ...
    and (
      (rv.varkey = 'wlg' and b.varkey = 'wd_limit_gpmo')
      or (rv.varkey = 'wl' and b.varkey = 'wd_limit_mgmo')
    ) 
